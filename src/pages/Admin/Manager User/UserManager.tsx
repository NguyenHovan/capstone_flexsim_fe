...
const UserManager: React.FC = () => {
  ...
  const handleToggleActive = (checked: boolean, record: Account) => {
    ...
    AccountService.updateAccount(record.id, {
      isActive: checked,
        ...
        >
          {viewingUser && (
            <div className="view-details">
              ...
              <p>
                <strong>Organization ID:</strong> {viewingUser.organizationId}
              </p>
              <p>
                <strong>System Mode:</strong>{" "}
                {viewingUser.systemMode ? "Yes" : "No"}
              </p>
              <p>
                <strong>Organization Role:</strong>{" "}
                {viewingUser.organizationRole || "N/A"}
              </p>
              <p>
              ...
              <p>
                ...
                {viewingUser.deleteAt
                  ? new Date(viewingUser.deleteAt).toLocaleDateString()
                  : "N/A"}
              </p>
              <Button
                type="primary"
